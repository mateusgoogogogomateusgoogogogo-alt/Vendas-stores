(() => {
  ...
  css.textContent = `
    ...
    .mtgx-profile-shell>*:not(.mtgx-profile-galaxy){position:relative;z-index:1}
    ...
    @media(max-width:700px){.mtgx-profile-galaxy{opacity:.8}.mtgx-galaxy-fields{grid-template-columns:1fr}.mtgx-galaxy-settings{padding:16px}.mtgx-galaxy-settings-head{display:block}.mtgx-galaxy-pill{display:inline-block;margin-top:10px}.mtgx-galaxy-status{display:block;margin:10px 0 0}}
